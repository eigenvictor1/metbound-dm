...
//na=0;Z_a[0]=0;zt=0;       
       ...
       { 
          ...
          double alpha;
//          printf("na=%d a=%E T=%E zt=%E vSigma=%E %E\n",na,exp(ln_a[na]),T_a[na],zt,vSigmaI(T_a[na],Beps_,&alpha)*3.8937966E8
